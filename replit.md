...
-   **Core Features**:
    ...
    -   **Coding Workbench**: Multi-panel IDE-like workbench (`/workbench`) with AI code chat, shell terminal, SSH remote terminal (connect to VPS via password or private key, run commands, SFTP file transfer), file explorer, Git panel, database explorer, environment variables viewer, and Catppuccin Mocha dark theme.
