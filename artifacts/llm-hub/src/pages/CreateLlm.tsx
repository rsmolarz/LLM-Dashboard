    ...
    return (
          <div className="flex-1 overflow-y-auto p-6 space-y-6">
                <div className="flex items-center gap-3 mb-2">
                        ...
                        <div>
                                  <h1 className="text-xl font-semibold text-foreground">Create LLM</h1>h1>
                                  <p className="text-sm text-muted-foreground">Build a custom model using an Ollama Modelfile</p>p>
                        </div>div>
                </div>div>
                        ...
                        <div className="space-y-5">
                                  <div className="rounded-xl border border-border bg-card p-5 space-y-4">
                                              ...
                                              <div className="space-y-1.5">
                                                            <label className="text-xs font-medium text-muted-foreground">Model Name</label>label>
                                                            <input
                                              ...
                                              <div className="space-y-1.5">
                                                            <label className="text-xs font-medium text-muted-foreground">Base Model</label>label>
                                                            <select
                                              ...
                                              <div className="space-y-1.5">
                                                            <label className="text-xs font-medium text-muted-foreground">System Prompt</label>label>
                                                            <textarea
                                              ...
                                              <div className="space-y-2">
                                                            <div className="flex items-center justify-between">
                                                                            <label className="text-xs font-medium text-muted-foreground">Temperature</label>label>
                                                                            <span className="text-xs font-bold text-violet-400 tabular-nums">{temperature.toFixed(1)}</span>span>
                                                            </div>div>
                                                            <input
                                                                              type="range"
                                                                              min={0}
                                                            ...
                                                            <div className="flex justify-between text-[10px] text-muted-foreground">
                                                                            <span>0.0 (precise)</span>span>
                                                                            <span>2.0 (creative)</span>span>
                                                            </div>div>
                                              </div>div>
                                  
                                              <div className="space-y-1.5">
                                                            <label className="text-xs font-medium text-muted-foreground">Context Window</label>label>
                                                            <input
                                                                              type="number"
                                                                              className="w-full rounded-lg border border-border bg-background px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-violet-500/50"
                                                                              value={contextWindow}
                                              ...
                                              <div className="space-y-1.5">
                                                            <label className="text-xs font-medium text-muted-foreground">Stop Sequences <span className="text-muted-foreground/60">(comma-separated)</span>span></label>label>
                                                            <input
                                                                              className="w-full rounded-lg border border-border bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-violet-500/50"
                                                                              placeholder="[DONE], </s>, ..."
                                                                              value={stopSequences}
                          ...
                          <div className="flex items-start gap-2 rounded-lg bg-emerald-500/10 border border-emerald-500/20 p-3">
                                          ...
                                          <p className="text-sm text-emerald-300">{statusMsg}</p>p>
                          </div>div>
                                              )}
                                    {status === "error" && (
                          <div className="flex items-start gap-2 rounded-lg bg-red-500/10 border border-red-500/20 p-3">
                                          <AlertCircle className="w-4 h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                          <p className="text-sm text-red-300">{statusMsg}</p>p>
                          </div>div>
                                              )}
                                  </div>div>
                        </div>div>
                        ...
                        <div className="space-y-5">
                                  <div className="rounded-xl border border-border bg-card p-5 space-y-3">
                                              ...
                                              <p className="text-xs text-muted-foreground">
                                                            This Modelfile will be sent to Ollama's <code className="text-violet-400">/api/create</code>code> endpoint to build your custom model.
                                              </p>p>
                                  </div>div>
                        </div>div>
                </div>div>
